...
qtun_scripts_dir="/data/adb/QTUN/scripts"

ui_print "********************************"
ui_print "*        QTUN WebUI By.E        *"
ui_print "*       PHP7  by: nosignal         *"
ui_print "********************************"
ui_print ""
...
ui_print "[10] Moving webui.sh..."
if [ -f "${www_dir}/webui.sh" ]; then
    mv ${www_dir}/webui.sh ${qtun_scripts_dir}/webui.sh
    set_perm ${qtun_scripts_dir}/webui.sh 0 0 0755
    ui_print "   webui.sh -> ${qtun_scripts_dir}"
elif [ -f "${MODPATH}/webui.sh" ]; then
    mv ${MODPATH}/webui.sh ${qtun_scripts_dir}/webui.sh
    set_perm ${qtun_scripts_dir}/webui.sh 0 0 0755
    ui_print "   webui.sh -> ${qtun_scripts_dir}"
else
    ui_print "   webui.sh not found"
fi
...
ui_print ""
ui_print "    QTUN Web UI by edoll"
ui_print "    PHP7 Server by nosignal"
ui_print ""
ui_print "    URL    http://127.0.0.1:80"
ui_print "    Login  admin / gstgg47e"
ui_print "    Script /data/adb/QTUN/scripts/webui.sh"
ui_print ""